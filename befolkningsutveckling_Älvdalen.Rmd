...
* `r unique(befolkning_df %>% filter(region == region_val) %>% .$region)`s folkmängd minskade under 2024, men minskningen var något lägre jämfört med året innan. Att minskningen var lägre beror i första hand på att såväl det inrikes som det utrikes flyttnettot ökade jämfört med året innan.
