...
* Den relativt stora nedgången i `r unique(befolkning_df %>% filter(region == region_val) %>% .$region)`s folkmängd år 2023, jämfört med åren innan, beror i första hand på att såväl det inrikes som utrikes flyttnettot till minskat tydligt jämfört med åren innan.
