...
Generellt invandrar ungefär lika många kvinnor och män, även om det har varit en viss övervikt för de sistnämnda efter på senare år. `r max(flytt_df$år)` var det  mestadels män som invandrade till `r unique(befolkning_df %>% filter(region == region_val) %>% .$region)` (netto).
