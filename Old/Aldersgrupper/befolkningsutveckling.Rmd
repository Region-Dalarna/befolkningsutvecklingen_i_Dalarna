...
# Sammanfattning {-}
* Dalarnas befolkning minskade med ungefär 500 personer under 2025, en befolkningsminskning som var mindre än året innan. Att befolkningsminskningen har dämpats något år 2025 beror framförallt på att färre personer flyttade från länet än tidigare. Totalt bodde det drygt 286 000 personer i Dalarna vid utgången av år 2025.
* År 2025 uppvisar det lägsta antalet födda barn i Dalarna sen mätningarna började år 1968. Sjunkande födelsetal är en nationell trend men också en trend i de flesta av världens utvecklade länder. De sjunkande födelsetalen planar ut något nationellt men inte i Dalarna. 
* Det är fler unga som flyttar från Dalarna till andra delar av Sverige än omvänt under år 2025, men i en mindre omfattning än året innan. 
* Enligt den senaste befolkningsprognosen från Region Dalarna (våren 2025) förväntas den negativa trenden i Dalarnas befolkningsutveckling fortsätta även i framtiden. Befolkningen minskar framförallt i yngre åldersgrupper, medan antalet äldre invånare förväntas öka avsevärt.

# Introduktion {-}
Hur folkmängden förändras över tid är en central fråga för såväl samhällsplanering som politik. Befolkningsutvecklingen påverkar allt från bostadsmarknaden och arbetsmarknaden till skatteintäkter och välfärdssystem. Såväl Västvärlden i stort som delar av Asien står inför en rad demografiska utmaningar, såsom en åldrande befolkning och minskande barnafödande. I Sverige var exempelvis barnafödandet per kvinna under 2025 det lägsta som uppmätts. 
...
All data som används i rapporten, förutom befolkningsprognoserna, är offentlig och finns under kategorin befolkning i SCB:s [Statistikdatabas](https://www.statistikdatabasen.scb.se/pxweb/sv/ssd/){target="_blank"}. Där finns även data för exempelvis befolkningsutvecklingen under 2025 på månadsbasis som publiceras löpande, något som inte behandlas i denna rapport.
...
*Notera att diagrammet nedan inte har uppdaterats med ny data. Detta sker eventuellt vid ett senare tillfälle.*
...
## Fruktsamhet
Summerad fruktsamhet per kvinna är ett mått på hur många barn som en kvinna i genomsnitt skulle föda under sin fruktsamma period utifrån, den vid tidpunkten för beräkningen, gällande fruktsamheten. I relation till befolkningen var barnafödandet i Sverige år 2025 det lägsta som uppmätts (SCB har data sedan mitten av 1700-talet), en utveckling som är densamma i stora delar av västvärlden ([SCB](https://www.scb.se/hitta-statistik/statistik-efter-amne/befolkning-och-levnadsforhallanden/befolkningens-sammansattning-och-utveckling/befolkningsstatistik/pong/statistiknyhet/befolkningsstatistik-ar-2025-omgang-1/){target="_blank"}). Skillnaden jämfört med 2024 var dock liten. En viktig förklaring till att barnafödandet har minskat i Sverige under 2010-talet är att sannolikheten att skaffa sitt första barn har minskat. För en fördjupad diskussion runt det låga barnafödandet i Sverige, se informationsrutan nedan.
...
Det är dock viktigt att notera att fruktsamheten på kommunnivå kan variera relativt mycket över tid. I större kommuner som Falun och Borlänge påminner utvecklingen om den i Dalarna och riket, där fruktsamheten ser ut att följa en trend. I mindre kommuner är variationen större mellan åren och det blir svårare att utläsa en långsiktig trend. Ett tydligt exempel på det är Gagnef som 2023 hade den högsta fruktsamheten bland länets kommuner, men året efter hade den lägsta. År 2025 var fruktsamheten i Gagnef återigen högst bland länets kommuner.
...
Bland Sveriges län sticker Skåne ut, med mer än dubbelt så stort inrikes flyttnetto som något annat län. Även Uppsala sticker ut, med stort flyttnetto relativt sin befolkning. Anmärkningsvärt är även att inrikes flyttnettot till Stockholms län var negativt under 2025, vilket är i linje med en trend de senaste åren. En viktig förklaring till det är sannolikt att den stora gruppen födda i början av 1990-talet börjar komma upp i 30-årsåldern och då väljer att flytta från Stockholm till mindre städer. Störst negativt inrikes flyttnetto hade Västerbottens län, vilket hänger samman med konkursen för batteritillverkaren Northvolt i Skellefteå, något som lett till en stor utflyttning. 

I Dalarna var det inrikes flyttnettot under `r max(flytt_overskott$år)` negativt och 6:e lägst bland Sveriges län.
...
Intressant att notera är dock att det inrikes flyttnettot i Dalarna under `r max(flytt_overskott$år)` var tydligt mindre negativt, jämfört med åren innan.

```{r, echo = FALSE, message = FALSE, warning = FALSE, fig.height=5, fig.width=8, fig.align='center'}
gg_flytt$`Inrikes flyttningsöverskott_Dalarna`
```

*Notera att de två diagrammen nedan inte har uppdaterats med ny data. Detta sker vid ett senare tillfälle.*
...
Trots att såväl det inrikes flyttnettot som födelsenettot i normala fall är negativa i Dalarna, har befolkningen i länet ökat med runt `r format(plyr::round_any(befolkning_df %>% filter(region == "Dalarnas län",år>"1999",variabel == "Folkökning") %>% .$varde %>% sum(),100),big.mark = " ")` personer sedan millennieskiftet. Detta beror på att den sista komponenten som styr befolkningsutvecklingen, det utrikes flyttnettot, har varit positivt.  Framförallt invandrade många till Dalarna under åren runt 2015-2016, då mer än 7000 personer netto flyttade till länet från utlandet under ett par år. Sedan dess har invandringen dock minskat avsevärt och under `r unique(flytt_overskott$år)` var det utrikes flyttnettot i Dalarna `r flytt_overskott %>% filter(region=="Dalarnas län",variabel == "Invandringsöverskott") %>% .$varde` personer. Detta är i linje med perioden 2019-2022 samt 2024, men klart högre än 2023. Den tydliga ökningen `r unique(flytt_overskott$år)` och 2024, jämfört med 2023, beror sannolikt delvis på att personer födda i Ukraina, som tidigare haft ett uppehållstillstånd med tillfälligt skydd enligt massflyktdirektivet, har haft möjlighet att ansöka om att bli folkbokförda i Sverige sedan i juni 2024 [(SCB)](https://www.scb.se/hitta-statistik/statistik-efter-amne/befolkning-och-levnadsforhallanden/befolkningens-sammansattning-och-utveckling/befolkningsstatistik/pong/statistiknyhet/befolkningsstatistik-helaret-20242/){target="_blank"}. Antalet folkbokförda i Dalarna födda i Ukraina har ökat från drygt 200 personer 2023 till 750 personer 2025 [(SCB)](https://www.statistikdatabasen.scb.se/pxweb/sv/ssd/START__BE__BE0101__BE0101E/FolkmRegFlandKCKM/table/tableViewLayout1/){target="_blank"}. 
...
Den främsta anledningen till det låga invandringsöverskottet på senare år är dock sannolikt en förändrad migrationspolitik. Med undantag för 2024, invandrade mellan 1 400 och 1 800 personer till Dalarna årligen under perioden 2020-2023 samt 2025, att jämföra med mellan 2 000 och 3 000 personer årligen åren dessförinnan. 
...
Sammantaget har Dalarnas län haft ett positivt flyttnetto under de flesta åren sedan millennieskiftet, vilket förklarar varför befolkningen har ökat. Efter att ha ökat marginellt under 2024, var flyttnettot till Dalarna tydligt mer positivt `r unique(flytt_overskott$år)`. Att flyttnettot blev mer positivt under `r unique(flytt_overskott$år)` beror på att det inrikes flyttnettot var mindre negativt, vilket diskuterades i avsnittet "inrikes flyttningar" ovan. 
...
*Notera att diagrammet nedan inte har uppdaterats med ny data. Detta sker vid ett senare tillfälle.*
...
I nästa avsnitt är fokus istället på framtiden. Hur kommer Dalarnas folkmängd att utvecklas fram till år 2034?
...
Till följd av att SCB bara gör befolkningsprognoser vart tredje år på läns- och kommunal nivå, har Region Dalarna, med hjälp av ett skript i R som Region Halland skapat, valt att ta fram egna befolkningsprognoser. Eftersom prognoser blir osäkrare desto längre fram i tiden de sträcker sig, är fokus i detta avsnitt enbart på prognosen 10 år framåt i tiden, dvs. fram till 2034. För SCB:s senaste befolkningsprognos för Dalarna, se [SCB, 2024](https://www.statistikdatabasen.scb.se/pxweb/sv/ssd/START__BE__BE0401__BE0401A/BefProgRegFakN/){target="_blank"}.

För en djupare förståelse för hur Region Dalarna gör sina befolkningsprognoser, se informationsrutan nedan. Till skillnad från de prognoser som SCB gör, har Region Dalarna valt att ta hänsyn till Ludvikas expansion kopplat till Hitachi i sina befolkningsprognoser. Detta påverkar även prognos för hela Dalarna. För övriga kommuner, tas ingen hänsyn i prognoserna till exempelvis företagsetableringar eller andra framtida mål och förutsättningar som kommunerna har i sina planer. Metoden är i övrigt till stora delar densamma som SCB använder.

<details>
<summary>Region Dalarnas Befolkningsprognoser</summary>

<div title="Källa: Region Dalarna">Den framtida befolkningens storlek och sammansättning bestäms av antaganden om den framtida utvecklingen av fruktsamhet, dödlighet och flyttningsmönster. Beräkningarna bygger på vad som observerats under de senaste åren och ett antagande om att den utvecklingen fortsätter. I beräkningarna tas ingen hänsyn till exempelvis företagsetableringar eller andra framtida mål och förutsättningar i kommunerna.
...
Befolkningsprognoser visar hur utvecklingen kommer att bli om den fortsätter ungefär som nu, alltså att fruktsamhet, dödlighet, flyttar samt invandring/utvandring fortsätter som tidigare i varje 1-årsgrupp per kön. 
</div>

</details>

I diagrammet nedan visas befolkningsutvecklingen i Dalarna fram till `r prognos_ar` uppdelat på åldersgrupper.

* Folkmängden i Dalarna prognostiseras att minska till `r befprognos_dalarna_totalt` personer år `r prognos_ar`, en minskning med ungefär `r befprognos_dalarna_totalt_forandring` personer jämfört med `r prognos_forsta_ar`. Även i SCB:s senaste prognos (juni 2024), prognostiserades en befolkning på ungefär 280 000 personer i Dalarna år `r prognos_ar` (se [SCB, 2024](https://www.statistikdatabasen.scb.se/pxweb/sv/ssd/START__BE__BE0401__BE0401A/BefProgRegFakN/){target="_blank"}).

* Den största minskningen sker i åldersgruppen 0-19 år, som prognostiseras att minska med knappt `r befprognos_dalarna_0_19_forandring` personer. Detta kan sannolikt delvis förklaras av att fruktsamheten minskat de senaste åren.

* I åldergruppen 80+ förväntas befolkning att öka med ungefär `r befprognos_dalarna_80plus_forandring` personer fram till `r prognos_ar`. Detta hänger sannolikt samman med att den förväntade livslängden fortsätter öka och att den stora gruppen "baby-boomers" börjar komma upp i 80-års åldern.

* Även antalet personer i åldersgrupp som brukar benämnas arbetsför ålder, 20-65 år, förväntas minska tydligt fram till `r prognos_ar`. 

```{r, echo = FALSE, message = FALSE, warning = FALSE, fig.height=5, fig.width=8, fig.align='center'}
gg_befprognos$befprogn_Dalarna_2025_10ars_sikt_antal
```

Bland Dalarnas kommuner är det två, Ludvika och Leksand, vars befolkning prognostiseras öka mellan `r prognos_forsta_ar` och `r prognos_ar`. I Ludvika förväntas befolkningen öka med drygt 9 procent, medan befolkningen i Leksand prognostiseras att öka med ungefär 1 procent. I övriga kommuner förväntas befolkningen minska, med Avesta och Älvdalen som de kommuner där befolkningen prognostiseras minska mest (procentuellt). I Avesta förväntas befolkningen minska med knappt 8 procent, medan befolkningen i Älvdalen förväntas minska med mer än 11 procent. Som nämnts tidigare i detta avsnitt, är det dock viktigt att ha i åtanke att Ludvika är den enda kommun för vilken prognosen tar hänsyn till en företagsetablering (Hitachi) och dess effekter på befolkningen. Prognosen för Ludvika kommun baseras på ett scenario som i allt väsentligt liknar den som Ludvika kommun själv tagit fram i deras scenario med medelstark tillväxt.

```{r, echo = FALSE, message = FALSE, warning = FALSE, fig.height=5, fig.width=8, fig.align='center'}
gg_befprognos_procent$`befprogn_dalarnas kommuner_andel_alla_tot`
```

# Kommunfördjupningar 

*Uppdatering av kommunfördjupningarna pågår. Publiceras vid ett senare tillfälle.*
