...
## Inrikes flyttnetto
Även det inrikes flyttnettot till `r unique(befolkning_df %>% filter(region == region_val) %>% .$region)`s varierar relativt mycket mellan åren, men är oftare negativt jämfört med det utrikes flyttnettot. Från 2016 och några år framåt flyttade relativt många till kommunen inrikes, men därefter har det inrikes flyttnettot varit litet eller negativt, troligtvis på grund av att personer som invandrat till kommunen valt att flytta till andra delar av Sverige av olika anledningar. Även år `r max(befolkning_df$år)` flyttade fler personer till än från kommunen inrikes, men utflyttningen (netto) var klart lägre än året innan.
