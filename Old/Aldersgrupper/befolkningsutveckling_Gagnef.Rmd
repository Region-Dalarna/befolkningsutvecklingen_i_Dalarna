...
* Precis som åren innan, minskade folkmängden i `r unique(befolkning_df %>% filter(region == region_val) %>% .$region)` år 2025.
* De senaste två åren har det fötts klart färre barn i Gagnef än tidigare, även om antalet födda barn ökade något mellan 2024 och 2025.
* Det utrikes flyttnettot till `r unique(befolkning_df %>% filter(region == region_val) %>% .$region)` minskade 2025, jämfört med året innan.
...
När det gäller antalet födslar har `r unique(befolkning_df %>% filter(region == region_val) %>% .$region)` länge skiljt sig från de flesta andra kommuner i Dalarna, då utvecklingen sedan slutet av 1960-talet har varit positiv. De senaste två åren har det dock fötts klart färre barn än tidigare, även om antalet födda barn ökade något mellan 2024 och `r max(fodda_doda_df$år)`.

Nettot mellan födda och döda, se de svarta linjerna i diagrammet nedan, varierar relativt mycket mellan åren, men har under 2010-talet och åren därefter mestadels varit positiv. De senaste två åren har dock de ovanligt låga födelsetalen lett till att födelsenettot har varit negativt i kommunen.
...
Efter att ha varit tydligt positivt år 2024, minskade invandringsöverskottet under `r max(flytt_df$år)` men var fortfarande positivt. Att nettot ökade så tydligt mellan 2023 och 2024 kan delvis förklaras med att personer födda i Ukraina sedan juni 2024 haft möjlighet att ansöka om att bli folkbokförda i Sverige, vilket medförde att antalet personer födda i Ukraina ökade med drygt 20 personer i kommunen under 2024 (se  [SCB](https://www.statistikdatabasen.scb.se/pxweb/sv/ssd/START__BE__BE0101__BE0101E/FolkmRegFlandK/table/tableViewLayout1/){target="_blank"}). Läs mer i den klickbara rutan "mer information om statistiken" ovan.
