...
* Till skillnad från många andra kommuner i Dalarna ökade `r unique(befolkning_df %>% filter(region == region_val) %>% .$region)`s befolkning år 2023.
