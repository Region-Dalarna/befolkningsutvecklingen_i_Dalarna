...
### Uppdelat på ålder
Ett mönster är att det till `r unique(befolkning_df %>% filter(region == region_val) %>% .$region)` flyttar fler personer mellan 30 och 39 år än de i samma åldersgrupp som flyttar därifrån, dvs. kommunens invånarantal i den åldersgruppen ökar på grund av inrikes flyttar. Inflyttningen i åldersgruppen (netto) minskade dock under `r max(flytt_aldersgrupper_df$år)`.
