...
* Den största minskningen sker i åldergruppen under 0-19 år,  som prognostiseras minska med  `r format(abs(plyr::round_any(befprognos_df %>% filter(alder_grupp == "0-19 år",region==region_val) %>% .$Folkmängd,10)),big.mark=" ")` personer.
