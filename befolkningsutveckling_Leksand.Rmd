...
När det gäller antalet födslar skiljer sig `r unique(befolkning_df %>% filter(region == region_val) %>% .$region)` från de flesta andra kommuner i Dalarna, då utvecklingen sedan slutet av 1960-talet har varit positiv. Visserligen föds det färre barn idag än det gjorde under slutet på 1980-talet, men utvecklingen under 2000-talet har varit stabil. Leksand är dessutom den kommun i Dalarna som under 2023 hade högst fruktsamhet (se rapporten för hela länet).  Under år `r max(fodda_doda_df$år)` föddes `r fodda_doda_df %>% filter(år == max(år),region == region_val,variabel == "födda") %>% .$varde` barn, vilket är den högsta siffran sedan 2020.
