...
<ul style = "columns : 2">
  ...
  <li>[Borlänge](https://samhallsanalys.regiondalarna.se/befolkningsutveckling_Borlänge.html){target="_blank"}</li>
  ...
  <li>[Malung-Sälen](https://samhallsanalys.regiondalarna.se/befolkningsutveckling_Malung_Sälen.html){target="_blank"}</li>
  ...
  <li>[Rättvik](https://samhallsanalys.regiondalarna.se/befolkningsutveckling_Rättvik.html){target="_blank"}</li>
  <li>[Smedjebacken](https://samhallsanalys.regiondalarna.se/befolkningsutveckling_Smedjebacken.html){target="_blank"}</li>
  <li>[Säter](https://samhallsanalys.regiondalarna.se/befolkningsutveckling_Säter.html){target="_blank"}</li>
  <li>[Vansbro](https://samhallsanalys.regiondalarna.se/befolkningsutveckling_Vansbro.html){target="_blank"}</li>
  <li>[Älvdalen](https://samhallsanalys.regiondalarna.se/befolkningsutveckling_Älvdalen.html){target="_blank"}</li>
</ul>
