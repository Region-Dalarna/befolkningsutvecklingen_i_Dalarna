...
* Det är framförallt i åldergruppen 0-19 år som befolkningen prognostiseras att minska, med ungefär `r format(abs(plyr::round_any(befprognos_df %>% filter(alder_grupp == "0-19 år",region=="Dalarna") %>% .$Folkmängd,100)),big.mark=" ")` personer. Detta hänger sannolikt samman med att fruktsamheten minskat tydligt de senaste åren.
