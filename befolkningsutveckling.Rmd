...
# Sammanfattning {-}
* Den lägre minskningen i Dalarnas folkmängd år 2024, jämfört med året innan, beror på att invandringen var klart högre. Detta beror sannolikt till stor del på att personer födda i Ukraina har haft möjlighet att ansöka om att bli folkbokförda i Sverige sedan i juni 2024 [(SCB)](https://www.scb.se/hitta-statistik/statistik-efter-amne/befolkning-och-levnadsforhallanden/befolkningens-sammansattning-och-utveckling/befolkningsstatistik/pong/statistiknyhet/namnlos/){target="_blank"}. 
...
*Observera att statistik i de två nästkommande diagrammen uppdateras först i slutet av mars.*
...
Trots att såväl det inrikes flyttnettot som födelsenettot i normala fall är negativa i Dalarna, har befolkningen i länet ökat med runt `r format(plyr::round_any(befolkning_df %>% filter(region == "Dalarnas län",år>"1999",variabel == "Folkökning") %>% .$varde %>% sum(),100),big.mark = " ")` personer sedan millennieskiftet. Detta beror på att den sista komponenten som styr befolkningsutvecklingen, det utrikes flyttnettot, har varit positivt.  Framförallt invandrade många till Dalarna under åren runt 2015-2016, då mer än 7000 personer netto flyttade till länet från utlandet under ett par år. Sedan dess har invandringen dock minskat avsevärt och under `r unique(flytt_overskott$år)` var det utrikes flyttnettot i Dalarna `r flytt_overskott %>% filter(region=="Dalarnas län",variabel == "Invandringsöverskott") %>% .$varde` personer. Detta är i linje med perioden 2019-2022, men klart högre än 2023. Den tydliga ökningen 2024 jämfört med 2023, beror sannolikt till stor del på att personer födda i Ukraina, som tidigare haft ett uppehållstillstånd med tillfälligt skydd enligt massflyktdirektivet, har haft möjlighet att ansöka om att bli folkbokförda i Sverige sedan i juni 2024 [(SCB)](https://www.scb.se/hitta-statistik/statistik-efter-amne/befolkning-och-levnadsforhallanden/befolkningens-sammansattning-och-utveckling/befolkningsstatistik/pong/statistiknyhet/namnlos/){target="_blank"}. Antalet folkbokförda i Dalarna födda i Ukraina ökade från drygt 200 personer 2023 till 667 personer 2024 [(SCB)](https://www.statistikdatabasen.scb.se/pxweb/sv/ssd/START__BE__BE0101__BE0101E/FolkmRegFlandK/table/tableViewLayout1/){target="_blank"}. 
...
Sammantaget har Dalarnas län haft ett positivt flyttnetto under de flesta åren sedan millennieskiftet, vilket förklarar varför befolkningen har ökat. Efter att ha varit tydligt negativt under 2023, var flyttnettot i Dalarna positivt `r unique(flytt_overskott$år)`. Att flyttnettot blev positivt under `r unique(flytt_overskott$år)` beror på att invandringsöverskottet ökade, vilket diskuterades i föregående avsnitt. 
