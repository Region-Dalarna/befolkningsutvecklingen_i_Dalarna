...
### Uppdelat på ålder
Ett tydligt mönster är att det i första hand är barn och unga under 20 år och personer mellan 30 år och 50 år som har flyttat till Malung-Sälen på senare år (netto). En förklaring till detta kan vara att det är barnfamiljer som flyttar till kommunen. I äldre åldersgrupper tenderar det inrikes flyttnettot att växla mellan positiva och negativa år. 
